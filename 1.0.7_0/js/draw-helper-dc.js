...
class DcHelperManager extends HelperManager {
    ...
    start() {
        ...
        dc_helperManger.helperTemplateFunc = helperTemplateFunc;
        dc_helperManger.generateHelperId = generateHelperId;
        dc_helperManger.on_newNode    = on_newNode;
        dc_helperManger.on_selected   = on_selected;
        dc_helperManger.on_mouseenter = on_mouseenter;
        dc_helperManger.on_deselected = on_deselected;
...
$(document).ready( function() {
    let dc_helperManger = new DcHelperManager();
    dc_helperManger.start();
});
